...
python iwd_algorithm.py datasetsfeb2015/trainC.csv datasets/wine.csv.infogain 10 10 10 0 0.7 --linear 1.5 linear 1 0.0 10 1.0 0.01 1 1 1.0 0.01 1 2 0.9 0.9 0.001 0 100 #| tee datasets/outputs/leu.output
